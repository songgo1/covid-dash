...
In response to the COVID-19 pandemic, local and federal agencies around the world began tracking cases to mediate spread. This data was aggregated by [Johns Hopkins University Center for Systems Science and Engineering (JHU CSSE)](https://github.com/CSSEGISandData/COVID-19/tree/master) and was published on an online dashboard that allowed real time tracking of the COVID-19 pandemic globally. In total, JHU CSSE collected data from 199 countries from 1/22/20 to 3/9/23. The dataset also contains case counts for the Summer 2020 and Winter 2022 Olympics. 
